...
forge test --fork-url http://erpc.erpc.svc.cluster.local/rpc/mainnet

# Fork at specific block (reproducible)
forge test --fork-url http://erpc.erpc.svc.cluster.local/rpc/mainnet --fork-block-number 19000000
