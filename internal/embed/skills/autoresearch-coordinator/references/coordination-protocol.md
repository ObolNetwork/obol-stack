...
| Worker discovery (static config) | 8004scan OASF query (`devops_mlops/model_versioning`) | Dynamic discovery; workers join/leave without coordinator restart |
...
1. Fetch all workers with `devops_mlops/model_versioning` skill from 8004scan
