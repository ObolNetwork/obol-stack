...
BIN_URL="https://raw.githubusercontent.com/$REPO/main/$INSTALLER_NAME/$INSTALLER_NAME"
...
if [[ ":$PATH:" != *":${BIN_DIR}:"* ]]; then
    # Add the obolup directory to the path and ensure the old PATH variables remain.
