...
| `obol network sync [<network>/<id>]` | Deploy to cluster (auto-selects if one instance) |
| `obol network sync --all` | Sync all network deployments |
| `obol network delete [<network>/<id>]` | Remove deployment (auto-selects if one instance) |
...
| `obol app sync [<app>/<id>]` | Deploy to cluster (auto-selects if one instance) |
| `obol app list` | List installed apps |
| `obol app delete [<app>/<id>]` | Remove app (auto-selects if one instance) |
